  ...
  return (
    <div className="flex w-full max-w-md flex-col items-center gap-2">
      <form
        ...
        className="flex w-full items-center rounded-full border border-input bg-transparent shadow-xs transition-[color,box-shadow] focus-within:border-ring focus-within:ring-[3px] focus-within:ring-ring/50"
        noValidate
      >
        <Input
          type="email"
