...
class BamlSyncClient:
    ...
    def MatchCategories(self, articles: typing.List["types.ArticleInput"],categories: typing.List["types.CategoryOption"],
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            __result__ = self.__options.merge_options(baml_options).call_function_sync(function_name="MatchCategories", args={
    ...
    def Summarize(self, title: str,content: str,
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            __result__ = self.__options.merge_options(baml_options).call_function_sync(function_name="Summarize", args={
...
class BamlStreamClient:
    ...
    def MatchCategories(self, articles: typing.List["types.ArticleInput"],categories: typing.List["types.CategoryOption"],
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[typing.List["stream_types.CategoryMatch"], typing.List["types.CategoryMatch"]]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="MatchCategories", args={
            "articles": articles,"categories": categories,
        })
        return baml_py.BamlSyncStream[typing.List["stream_types.CategoryMatch"], typing.List["types.CategoryMatch"]](
          __result__,
    ...
    def Summarize(self, title: str,content: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.SummarizeResult, types.SummarizeResult]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="Summarize", args={
            "title": title,"content": content,
        })
        return baml_py.BamlSyncStream[stream_types.SummarizeResult, types.SummarizeResult](
          __result__,
...
class BamlHttpRequestClient:
    ...
    def MatchCategories(self, articles: typing.List["types.ArticleInput"],categories: typing.List["types.CategoryOption"],
        ...
        __result__ = self.__options.merge_options(baml_options).create_http_request_sync(function_name="MatchCategories", args={
            "articles": articles,"categories": categories,
        }, mode="request")
        return __result__
    def SelectNotableProducts(self, products: typing.List["types.NewsletterProduct"],
    ...
    def Summarize(self, title: str,content: str,
        ...
        __result__ = self.__options.merge_options(baml_options).create_http_request_sync(function_name="Summarize", args={
            "title": title,"content": content,
        }, mode="request")
        return __result__
