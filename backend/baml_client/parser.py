...
class LlmResponseParser:
    ...
    def CategorizeContent(
        self, llm_response: str, baml_options: BamlCallOptions = {},
    ) -> types.CategorizeContentResult:
        __result__ = self.__options.merge_options(baml_options).parse_response(function_name="CategorizeContent", llm_response=llm_response, mode="request")
        return typing.cast(types.CategorizeContentResult, __result__)
...
class LlmStreamParser:
    ...
    def CategorizeContent(
        self, llm_response: str, baml_options: BamlCallOptions = {},
    ) -> stream_types.CategorizeContentResult:
        __result__ = self.__options.merge_options(baml_options).parse_response(function_name="CategorizeContent", llm_response=llm_response, mode="stream")
        return typing.cast(stream_types.CategorizeContentResult, __result__)
